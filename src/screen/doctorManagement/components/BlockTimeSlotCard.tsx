...
const BlockTimeSlotCard: React.FC<Props> = ({ onBlock }) => {
  ...
  const [pickerType, setPickerType] = useState<'date' | 'start' | 'end' | null>(
    null,
  );
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.subTitle}>
        Leave empty to fully block the time slot. Enter number to reserve that
        many slots for VIP / walk-in patients.
      </Text>
      ...
      <AppButton
        ...
        color="#fff"
        containerStyle={styles.timeBlockBtn}
      />
